        ...
        <footer className="flex justify-between w-full bg-darkGreen/30 py-20">
            <div className="max-w-6xl px-5 md:px-0 mx-auto w-full">
                ...
                <div className="inline-flex border-y border-white/20 justify-center items-center py-[30px] space-x-10 text-white text-sm capitalize w-full">
                    <Link className="LinkTxt" href="https://learn.freebling.app/privacy-policy" target="_blank">Privacy Policy</Link>
                    <Link className="LinkTxt" href="https://learn.freebling.app/terms-and-conditions" target="_blank">Terms & Conditions</Link>
                </div>

                <div className="inline-flex justify-between items-center py-[30px] space-x-10 w-full">
                    <p className="mx-auto text-center text-white text-sm">Copyright © 2026 <Link href="/">FreeBling.app</Link>. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
